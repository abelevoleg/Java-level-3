...
public class Main {
    public static void main(String[] args) throws IOException {
        // пункт 1
        try {
            byte[] arr = Files.readAllBytes(Paths.get("123/task1.txt"));
    ...
    static void readPage() {
        // не очень понятно, что значит "контролируем время выполнения". Сделал контроль в виде засечки времени
        // загрузки и чтения страницы и вывода этих величин в консоль
         ...
         try (RandomAccessFile raf = new RandomAccessFile("123/task3.txt", "r");
             ...
             while (true) {
                 ...
                 if (numberPage <= pagesCount && numberPage >= 0) {
                     ...
                     for (byte page : b) System.out.print((char) page);
